    ...
    <div class="container">
        <div class="row">
            <div class="categories__slider owl-carousel">
                ...
                ?>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="image/<?php echo $row["anh"]; ?>">
                        <h5><a href="#"><?php echo $row["loai_hang_ten"]; ?></a></h5>
                    </div>
                </div>
                <?php
                        }
...
<section class="featured spad">
    <div class="container">
        ...
        <div class="row featured__filter">
            <?php
                $sql = "SELECT id, sp_ten, sp_gia, sp_anh FROM san_pham LIMIT 8";
                $result = $conn->query($sql);
                if($result->num_rows > 0)
                    while($row=$result->fetch_array()){
            ?>
